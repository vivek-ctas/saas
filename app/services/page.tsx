...
export const metadata: Metadata = buildMetadata({
  title: "Services - Centralized Inventory, Order Management, AI Tools & More",
  description:
    "Explore core seller services in one platform: centralized inventory, unified order management, real-time sync, AI catalog generation, analytics, and more.",
  path: "/services",
});
...
const servicesJsonLd = {
  ...
  description:
    "Services built for multichannel sellers: centralized inventory, order management, real-time sync, AI catalog, variants & matching, analytics, asset library, role access, and bulk work.",
  itemListElement: [
