...
export default function SetupPasswordPage() {
  ...
  if (tokenStatus === 'checking') {
    return (
      <StatusScreen
        icon={<Loader2 className="w-10 h-10 text-[#3C9AC4] animate-spin" />}
      ...
      <StatusScreen
        ...
        cta={
          <Link
            ...
            className="mt-4 inline-flex items-center gap-2 rounded-full bg-[#3C9AC4] text-white px-6 py-2.5 text-sm font-semibold hover:opacity-90"
          >
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm px-10 py-14 max-w-md w-full text-center">
          ...
          {resendDone ? (
            ...
            <button
              ...
              disabled={resending}
              className="w-full h-12 rounded-2xl bg-gradient-to-r from-[#13355A] to-[#0D2440] text-white
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm px-10 py-12 max-w-md w-full">
        ...
        <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-[#E8F0F6] mx-auto mb-6">
          <Lock className="w-7 h-7 text-[#3C9AC4]" />
        </div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-xl border border-slate-200 px-4 py-2.5 pr-11 text-sm
                         text-slate-900 focus:border-[#3C9AC4] focus:outline-none focus:ring-2 focus:ring-[#3C9AC4]/20"
            />
            <button
              type="button"
