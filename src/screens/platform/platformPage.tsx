        ...
        <section className="relative overflow-hidden hero-cream slope-divider-bottom py-14">
          ...
          <div className="px-5 sm:px-8 lg:px-[70px] grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div className="reveal">
              <Badge className="mb-3 bg-white text-[#13355A] border border-[#BDD9EE] shadow-sm hover:bg-white">
                {cfg.eyebrow}
              </Badge>
        ...
        <section className="py-14 sm:py-16 lg:py-20 bg-white border-t border-[#EAECF3]">
          <div className="px-5 sm:px-8 lg:px-[70px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {/* After */}
              <div className="reveal delay-100 group rounded-3xl border border-[#BDD9EE] bg-gradient-to-br from-[#E8F0F6] to-[#E8F0F6]/30 p-7 relative overflow-hidden hover:border-[#BDD9EE] hover:shadow-lg transition-all duration-300">
                ...
                <div className="flex items-start gap-3 mb-5">
                  <div className="w-8 h-8 rounded-full bg-[#E8F0F6] border border-[#BDD9EE] flex items-center justify-center shrink-0 mt-0.5">
                    <CheckCircle2 className="w-4 h-4 text-[#3C9AC4]" />
                  </div>
                  <div>
                    <Badge className="mb-1.5 bg-white text-[#13355A] border border-[#BDD9EE] shadow-sm text-xs hover:bg-white">With SellerBuz</Badge>
                ...
                <ul className="space-y-3">
                  {cfg.solution.points.map((p) => (
                    <li key={p} className="flex items-start gap-3 text-sm text-slate-700">
                      <CheckCircle2 className="w-4 h-4 text-[#3C9AC4] mt-0.5 shrink-0" />
                      {p}
                    </li>
                  ))}
                </ul>
          ...
          <div className="px-5 sm:px-8 lg:px-[70px]">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {cfg.deepDives.map((s, i) => (
                <div
                  key={s.eyebrow}
                  className="reveal group rounded-2xl bg-white border border-slate-200/70 flex flex-col overflow-hidden hover:border-[#BDD9EE] hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                ...
                >
                  ...
                  <div className="relative h-44 bg-slate-50/80 border-b border-slate-100 overflow-hidden flex items-start justify-center pt-1">
                    ...
                    <div className="absolute bottom-2.5 left-3 z-10">
                      <Badge className="bg-white/95 text-[#13355A] border border-[#BDD9EE] shadow-sm text-[11px] backdrop-blur-sm">
                        {s.eyebrow}
                      </Badge>
                    </div>
                  </div>
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    <div className="flex items-center gap-2.5 mb-3">
                      <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-[#3C9AC4] to-[#13355A] flex items-center justify-center shrink-0 shadow-sm group-hover:scale-110 transition-transform duration-300">
                    ...
                    <ul className="space-y-1.5 mb-4">
                      {s.bullets.slice(0, 2).map((b) => (
                        <li key={b} className="flex items-start gap-2 text-xs text-slate-600">
                          <CheckCircle2 className="w-3.5 h-3.5 text-[#3C9AC4] mt-0.5 shrink-0" />
                          {b}
                        </li>
                      ))}
                    </ul>
                        ...
                        {s.bullets.map((b) => (
                          <li key={b} className="flex items-start gap-3 text-sm text-slate-700">
                            <span className="w-5 h-5 rounded-full bg-[#E8F0F6] border border-[#BDD9EE] flex items-center justify-center shrink-0 mt-0.5">
                              <CheckCircle2 className="w-3 h-3 text-[#3C9AC4]" />
                            </span>
                            {b}
                          </li>
                        ))}
              ...
              <section key={s.eyebrow} className="py-14 sm:py-16 lg:py-20 bg-white border-t border-[#EAECF3]">
                <div className="px-5 sm:px-8 lg:px-[70px]">
                  ...
                  <div className="reveal delay-200 grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-3xl mx-auto">
                    {s.bullets.map((b) => (
                      <div key={b} className="flex items-start gap-3 rounded-2xl bg-white border border-slate-200/70 px-4 py-3 hover:border-[#BDD9EE] hover:shadow-md hover:bg-[#E8F0F6]/20 transition-all duration-200">
                        <CheckCircle2 className="w-4 h-4 text-[#3C9AC4] mt-0.5 shrink-0" />
                    ...
                    <ul className="space-y-3 mb-8">
                      {s.bullets.map((b) => (
                        <li key={b} className="flex items-start gap-3 text-sm text-slate-700 group/li cursor-default">
                          <span className="flex items-center justify-center w-5 h-5 rounded-full bg-[#E8F0F6] border border-[#BDD9EE] shrink-0 mt-0.5 group-hover/li:bg-[#3C9AC4] group-hover/li:border-[#3C9AC4] transition-colors duration-200">
                            <CheckCircle2 className="w-3 h-3 text-[#3C9AC4] group-hover/li:text-white transition-colors duration-200" />
                          </span>
                          {b}
                        </li>
                      ))}
            ...
            <div className="px-5 sm:px-8 lg:px-[70px]">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                {cfg.featureGrid.map((f, idx) => (
                  <div
                    key={f.t}
                    className="reveal group flex flex-col items-center text-center gap-3 rounded-2xl bg-white border border-slate-200/70 px-3 py-4 hover:border-[#BDD9EE] hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300"
                    style={{ animationDelay: `${idx * 50}ms` }}
                  >
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#3C9AC4] to-[#13355A] flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
        ...
        {cfg.channels && (
          <section className="py-16 sm:py-20 lg:py-24 bg-[#F7F9FC] border-t border-[#EAECF3] relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[350px] bg-gradient-to-b from-[#E8F0F6]/60 to-transparent rounded-full blur-3xl" />
            </div>
            ...
            <div className="relative px-5 sm:px-8 lg:px-10 xl:px-[70px]">
              ...
              <div className="text-center mb-12 reveal">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-[#BDD9EE] shadow-sm text-[#13355A] text-xs font-semibold mb-5">
              ...
              <div className="reveal delay-100">
                ...
                <div className="hidden lg:flex items-center justify-center gap-0">
                  ...
                  <div className="flex flex-col items-center gap-3">
                    <div className="w-[148px] bg-white border border-slate-200/80 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 hover:border-[#BDD9EE] transition-all duration-300 p-4 flex flex-col items-center gap-3 cursor-default">
                      <div className="w-12 h-12 rounded-xl bg-[#E8F0F6] border border-[#BDD9EE] flex items-center justify-center pipeline-pulse">
                        <svg className="w-6 h-6 text-[#3C9AC4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="relative flex items-center w-16 shrink-0 overflow-visible">
                    <div className="w-full border-t-2 border-dashed border-[#BDD9EE]" />
                    <div className="flow-dot flow-dot-d1 absolute left-0 w-2 h-2 rounded-full bg-[#3C9AC4] shadow-[0_0_6px_rgba(60,154,196,0.6)]" />
                    <div className="flow-dot flow-dot-d2 absolute left-0 w-2 h-2 rounded-full bg-[#6BC1E0] shadow-[0_0_6px_rgba(60,154,196,0.4)]" />
                    <div className="flow-dot flow-dot-d3 absolute left-0 w-2 h-2 rounded-full bg-[#6BC1E0] shadow-[0_0_6px_rgba(60,154,196,0.3)]" />
                    <svg className="absolute right-0 w-3 h-3 text-[#6BC1E0]" fill="currentColor" viewBox="0 0 8 8">
                  ...
                  <div className="flex flex-col items-center gap-3">
                    <div className="w-[148px] bg-white border border-slate-200/80 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 hover:border-[#BDD9EE] transition-all duration-300 p-4 flex flex-col items-center gap-3 cursor-default">
                      <div className="w-12 h-12 rounded-full bg-[#E8F0F6] border-2 border-[#6BC1E0] flex items-center justify-center pipeline-pulse" style={{ animationDelay: "0.4s" }}>
                        <svg className="w-6 h-6 text-[#3C9AC4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="relative flex items-center w-16 shrink-0 overflow-visible">
                    <div className="w-full border-t-2 border-dashed border-[#BDD9EE]" />
                    <div className="flow-dot flow-dot-d2 absolute left-0 w-2 h-2 rounded-full bg-[#3C9AC4] shadow-[0_0_6px_rgba(60,154,196,0.6)]" />
                    <div className="flow-dot flow-dot-d3 absolute left-0 w-2 h-2 rounded-full bg-[#6BC1E0] shadow-[0_0_6px_rgba(60,154,196,0.4)]" />
                    <svg className="absolute right-0 w-3 h-3 text-[#6BC1E0]" fill="currentColor" viewBox="0 0 8 8">
                      <polygon points="0,0 8,4 0,8" />
                    </svg>
                  </div>
                  ...
                  <div className="flex flex-col items-center gap-3">
                    <div className="w-[148px] bg-white border border-slate-200/80 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 hover:border-[#BDD9EE] transition-all duration-300 p-4 flex flex-col items-center gap-3 cursor-default">
                      <div className="w-12 h-12 rounded-xl bg-[#E8F0F6] border border-[#BDD9EE] flex items-center justify-center pipeline-pulse" style={{ animationDelay: "0.8s" }}>
                        <svg className="w-6 h-6 text-[#3C9AC4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex flex-col items-center gap-3">
                    <div className="w-[148px] bg-white border border-slate-200/80 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 hover:border-[#BDD9EE] transition-all duration-300 p-4 flex flex-col items-center gap-3 cursor-default">
                      <div className="w-12 h-12 rounded-xl bg-[#E8F0F6] border border-[#BDD9EE] flex items-center justify-center pipeline-pulse" style={{ animationDelay: "1.2s" }}>
                        <svg className="w-6 h-6 text-[#3C9AC4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="relative flex items-center w-16 shrink-0 overflow-visible">
                    <div className="w-full border-t-2 border-dashed border-[#BDD9EE]" />
                    <div className="flow-dot flow-dot-d3 absolute left-0 w-2 h-2 rounded-full bg-[#3C9AC4] shadow-[0_0_6px_rgba(60,154,196,0.6)]" />
                    <div className="flow-dot flow-dot-d1 absolute left-0 w-2 h-2 rounded-full bg-[#6BC1E0] shadow-[0_0_6px_rgba(60,154,196,0.4)]" />
                    <svg className="absolute right-0 w-3 h-3 text-[#6BC1E0]" fill="currentColor" viewBox="0 0 8 8">
                      <polygon points="0,0 8,4 0,8" />
                    </svg>
                  </div>
                  ...
                  <Link href="/marketplaces/amazon" className="flex flex-col items-center gap-3 cursor-pointer">
                    <div className="flex flex-col items-center gap-3">
                      <div className="w-[164px] bg-white border-2 border-[#6BC1E0] rounded-2xl shadow-xl shadow-[#E8F0F6]/50 hover:shadow-2xl hover:-translate-y-1 hover:border-[#3C9AC4] transition-all duration-300 p-5 flex flex-col items-center gap-3  relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-[#E8F0F6]/60 to-white pointer-events-none" />
                        ...
                        <div className="relative text-center">
                          ...
                          <span className="inline-flex items-center gap-1 mt-1.5 px-2 py-0.5 rounded-full bg-[#E8F0F6] text-[#13355A] text-[10px] font-semibold">
                            <span className="w-1.5 h-1.5 rounded-full bg-[#3C9AC4] inline-block" />
                            Updated
                          </span>
                ...
                <div className="flex lg:hidden flex-col items-center gap-0">
                  {[
                    ...
                    <div key={stage.label} className="flex flex-col items-center">
                      <div className="flex items-center gap-3 w-full max-w-xs bg-white border border-slate-200 rounded-2xl shadow-sm px-4 py-3">
                        <div className="w-9 h-9 rounded-xl bg-[#E8F0F6] border border-[#BDD9EE] flex items-center justify-center shrink-0">
                          {stage.icon}
                        </div>
                        <div>
                  ...
                  <div className="flex flex-col items-center mt-1">
                    ...
                    <div className="flex items-center gap-3 w-full max-w-xs bg-white border-2 border-[#6BC1E0] rounded-2xl shadow-lg px-4 py-3">
                      ...
                      <div>
                        <p className="text-sm font-bold text-slate-900">Amazon</p>
                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[#E8F0F6] text-[#13355A] text-[10px] font-semibold">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#3C9AC4] inline-block" /> Updated
                        </span>
                      </div>
              ...
              <div className="reveal delay-200 mt-12 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto">
                {[
                  {
                    icon: <svg className="w-5 h-5 text-[#3C9AC4]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
                    v: "< 2s", l: "Sync Time",
                  },
                  {
                    icon: <svg className="w-5 h-5 text-[#3C9AC4]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" strokeWidth={1.5} /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6v6l4 2" /></svg>,
                    v: "99.99%", l: "Uptime",
                  },
                  {
                    icon: <svg className="w-5 h-5 text-[#3C9AC4]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>,
                    v: "100%", l: "Data Safe",
                  },
                  {
                    icon: <svg className="w-5 h-5 text-[#3C9AC4]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>,
                    v: "Real-time", l: "Always Updated",
                  },
                ].map((s) => (
                  <div
                    key={s.l}
                    className="flex items-center gap-3 bg-white border border-slate-200/80 rounded-2xl px-4 py-3 shadow-sm hover:border-[#BDD9EE] hover:shadow-md transition-all duration-200"
                  >
                    <div className="w-9 h-9 rounded-xl bg-[#E8F0F6] border border-[#BDD9EE] flex items-center justify-center shrink-0">
                      {s.icon}
                    </div>
                    <div>
                      <p className="text-sm font-bold text-[#3C9AC4] leading-tight">{s.v}</p>
