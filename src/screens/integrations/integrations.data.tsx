...
export const INTEGRATIONS: Integration[] = [
  {
    ...
    features: [
      { title: "SP-API v2 native", desc: "Granular role scoping, automatic token refresh and rate-limit budgeting per Sellerbuz." },
  ...
  },
  {
    ...
    name: "Walmart",
    region: "USA · Walmart Sellerbuz + WFS",
    category: "Global Sellerbuz",
    tone: "from-blue-600 to-primary",
    icon: Store,
    tagline: "Walmart Sellerbuz, finally without the spreadsheets.",
    description:
      "Connect Walmart Sellerbuz, WFS and Walmart Connect ads. Item setup wizard, listing-quality score and order acknowledgement on autopilot.",
  ...
  },
  {
    ...
    stats: [
      { label: "Peak orders/min", value: "9.4k" },
