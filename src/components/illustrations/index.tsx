  ...
  return (
    <svg viewBox="0 0 1040 540" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} >
      ...
      {[
        ...
        { tx: 350, stroke: "#2563EB", logo: "logos/walmart.png", label: "Walmart" },
        { tx: 505, stroke: "#2563EB", logo: "logos/EBay_logo.svg.webp", label: "eBay" },
        { tx: 660, stroke: "#2563EB", logo: "logos/etsy-svgrepo-com.svg", label: "Etsy" },
        { tx: 815, stroke: "#2563EB", logo: "logos/fnac.png", label: "Fnac" },
      ].map((n, i) => (
      ...
      {[
        { x: 195, c: "#2563EB" }, { x: 350, c: "#2563EB" }, { x: 505, c: "#2563EB" },
        { x: 660, c: "#2563EB" }, { x: 815, c: "#2563EB" },
      ].map((l, i) => (
        <g key={"vl" + l.x}>
