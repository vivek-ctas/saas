...
export const ContactMapIllustration = (props: SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 600 360" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            Array.from({ length: 30 }).map((_, c) => {
                ...
                return (
                    <circle key={`${r}-${c}`} cx={cx} cy={cy} r={1.6}
                        fill={land ? "#3C9AC4" : "#cbd5e1"} opacity={land ? 0.7 : 0.35} />
                );
            })
        )}
        {/* Hub pins */}
        {[
            ...
            <g key={h.label}>
                <circle cx={h.x} cy={h.y} r={14} fill="#3C9AC4" opacity={0.2}>
                ...
                <circle cx={h.x} cy={h.y} r={6} fill="#3C9AC4" stroke="white" strokeWidth={2} />
        ...
        {/* Arc connections */}
        <path d="M130 180 Q 220 60, 360 175" stroke="#3C9AC4" strokeWidth={1.5} fill="none" strokeDasharray="4 4" opacity={0.6} />
        <path d="M360 175 Q 420 90, 460 200" stroke="#3C9AC4" strokeWidth={1.5} fill="none" strokeDasharray="4 4" opacity={0.6} />
        <path d="M460 200 Q 510 240, 500 270" stroke="#3C9AC4" strokeWidth={1.5} fill="none" strokeDasharray="4 4" opacity={0.6} />
